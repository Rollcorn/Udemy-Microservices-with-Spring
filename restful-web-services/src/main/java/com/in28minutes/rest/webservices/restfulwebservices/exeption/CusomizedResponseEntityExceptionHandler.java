...
@ControllerAdvice
@RestController
public class CusomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleAllExeption(Exception ex, WebRequest request){
        ...
        return new ResponseEntity(exeptoinResponse, HttpStatus.INTERNAL_SERVER_ERROR);
    }
